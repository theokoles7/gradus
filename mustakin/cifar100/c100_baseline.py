...
def load_images(batch_size=128, val_size=5000):
    ...
    Identical split logic to the curriculum scripts for a fair comparison:
      ...
      - 10,000 test samples (official CIFAR-100 test set)
...
def plot_training_metrics(
    ...
    val_losses,
    val_accs,
    save_path="training_metrics_c100_baseline.pdf",
):
...
def plot_confusion_matrix(
    ...
    save_path="confusion_matrix_c100_baseline.pdf",
):
...
def run_cifar100_baseline():
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "best_resnet18_c100_baseline.pth")
    ...
    summary = {
        ...
        "val_samples": [5000],
        "test_samples": [10000],
        "curriculum_type": ["c100_baseline_random_shuffle"],
    }

    summary_df = pd.DataFrame(summary)
    summary_df.to_csv("c100_baseline_learning_summary.csv", index=False)
    print("\nSummary saved to c100_baseline_learning_summary.csv")
    ...
    epoch_df.to_csv("c100_baseline_epoch_history.csv", index=False)
    print("Epoch history saved to c100_baseline_epoch_history.csv")
...
if __name__ == "__main__":
    ...
    model, summary_df = run_cifar100_baseline()
