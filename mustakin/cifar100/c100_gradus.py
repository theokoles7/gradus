...
def plot_confusion_matrix(
    ...
    save_path="confusion_matrix_curriculum_c100_gradus.pdf",
):
...
def run_cifar100_curriculum_learning():
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "best_resnet18_curriculum_c100_gradus.pth")
    ...
    plot_confusion_matrix(
        ...
        test_preds,
        class_names,
        title="Test Set Confusion Matrix (Curriculum Learning - Gradus)",
    )
    ...
    summary_df.to_csv("curriculum_learning_summary_c100_gradus.csv", index=False)
    print("\nSummary saved to curriculum_learning_summary_c100_gradus.csv")
    ...
    epoch_df.to_csv("curriculum_epoch_history_c100_gradus.csv", index=False)
    print("Epoch history saved to curriculum_epoch_history_c100_gradus.csv")
...
if __name__ == "__main__":
    ...
    model, summary_df = run_cifar100_curriculum_learning()
