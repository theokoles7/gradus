...
def plot_complexity_distribution(
    features_df, save_path="complexity_distribution_c100_gradus_anti.pdf"
):
...
def plot_curriculum_schedule(
    ...
    total_samples,
    samples_per_epoch,
    save_path="anti_curriculum_schedule_c100_gradus.pdf",
):
...
def plot_training_metrics(
    ...
    val_losses,
    val_accs,
    save_path="training_metrics_anti_curriculum_c100_gradus.pdf",
):
...
def plot_confusion_matrix(
    ...
    save_path="confusion_matrix_anti_curriculum_c100_gradus.pdf",
):
...
def run_cifar100_anti_curriculum_learning():
    ...
    features_df.to_csv("image_complexity_features_c100_gradus_anti.csv", index=True)
    print("Saved complexity features to image_complexity_features_c100_gradus_anti.csv")
    ...
    for epoch in range(1, total_epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(
                model.state_dict(), "best_resnet18_anti_curriculum_c100_gradus.pth"
            )
    ...
    summary_df.to_csv("anti_curriculum_learning_summary_c100_gradus.csv", index=False)
    print("\nSummary saved to anti_curriculum_learning_summary_c100_gradus.csv")
    ...
    epoch_df.to_csv("anti_curriculum_epoch_history_c100_gradus.csv", index=False)
    print("Epoch history saved to anti_curriculum_epoch_history_c100_gradus.csv")
...
if __name__ == "__main__":
    ...
    model, summary_df = run_cifar100_anti_curriculum_learning()
